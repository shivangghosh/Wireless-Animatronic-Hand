...
myServo1.attach(15); //A1 myServo3.attach(16); 
//A2 myServo4.attach(17); //A3 
myServo2.attach(18); //A4 myServo5.attach(19); 
//A5
radio.begin(); //it activates the modem. radio.openReadingPipe(1, pipe); //determines the address of our modem which receive data.
